...
public partial class Transaction_Pages_Customer_Attendance_Update : System.Web.UI.Page
{
    ...
    protected void Grid_Search_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            //Response.Redirect(GetRouteUrl("Customer_Attendance_Route", new { Customer_ID = HttpUtility.UrlEncode(encrypted_ID) }), false);
